...
<script src="<?php echo e(asset('public/backend/js/jquery-1.10.2.min.js')); ?>"></script>
...
<!--Easy Pie Chart-->
<script src="<?php echo e(asset('public/backend/js/easypiechart/jquery.easypiechart.js')); ?>"></script>
<!--Sparkline Chart-->
<script src="<?php echo e(asset('public/backend/js/sparkline/jquery.sparkline.js')); ?>"></script>
<!--jQuery Flot Chart-->
<script src="<?php echo e(asset('public/backend/js/flot-chart/jquery.flot.js')); ?>"></script>
<script src="<?php echo e(asset('public/backend/js/flot-chart/jquery.flot.tooltip.min.js')); ?>"></script>
<script src="<?php echo e(asset('public/backend/js/flot-chart/jquery.flot.resize.js')); ?>"></script>
<script src="<?php echo e(asset('public/backend/js/flot-chart/jquery.flot.pie.resize.js')); ?>"></script>
...
<script type="text/javascript" src="<?php echo e(asset('public/backend/js/bootstrap-datetimepicker/js/bootstrap-datetimepicker.js')); ?>"></script>
<script type="text/javascript" src="<?php echo e(asset('public/backend/js/bootstrap-datepicker/js/bootstrap-datepicker.js')); ?>"></script>

<script type="text/javascript" src="<?php echo e(asset('public/backend/plugin/chosen/chosen.jquery.min.js')); ?>"></script>
<script src="//cdn.ckeditor.com/4.5.10/standard/ckeditor.js"></script>
<!--common script init for all pages-->


<script src="<?php echo e(asset('public/backend/js/advanced-form.js')); ?>"></script>
