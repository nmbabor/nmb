	...
	<div class="container">
		...
		<div class="profile">
			<div class="row">
				...
				<div class="col-sm-10">
					<div class="business-section">
						...
						<div class="profile-details section">
							<h1 class="title">Create Resume</h1>
							<hr>
							<!-- form -->
							{!! Form::open(array('route' => 'resume.store','class'=>'form-horizontal', 'data-toggle'=>'validator','role'=>'form','method'=>'post','files'=>'true')) !!}
							...
							<div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									<input name="email" type="text" class="form-control" placeholder="Email" value="{{$profile->email}}" required>
									<div class="help-block with-errors"></div>
									 @if ($errors->has('email'))
		                                <span class="help-block">
							...
							<div class="form-group{{ $errors->has('mobile') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									<input name="mobile" type="number" min="0" class="form-control" placeholder="Mobile Number" value="{{$profile->mobile}}" required>
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('fathers_name') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									<input name="fathers_name" type="text" class="form-control" placeholder="Father's Name" value="{{old('fathers_name')}}">
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('mothers_name') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									<input name="mothers_name" type="text" class="form-control" placeholder="Mother's Name" value="{{old('mothers_name')}}">
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									<input name="date_of_birth" type="text" class="form-control datepicker" placeholder="Date of birth" value="01-01-1995" required>
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									{{Form::select('gender',['Male'=>'Male','Female'=>'Female','Other'=>'Other'],'',['class'=>'form-control','required'])}}
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('religion') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									<input name="religion" type="text" class="form-control" placeholder="Religion" value="{{old('religion')}}" required>
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('present_address') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									{{Form::textArea('present_address','',['class'=>'form-control','placeholder'=>'Present Address','required','rows'=>'2'])}}
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('permanent_address') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									{{Form::textArea('permanent_address','',['class'=>'form-control','placeholder'=>'Permanent Address','required','rows'=>'2'])}}
									<div class="help-block with-errors"></div>
				...
				<div class="col-sm-2 no-padding-left text-center">
