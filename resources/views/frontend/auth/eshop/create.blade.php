				...
				<div class="col-sm-9 no-padding-left">
					<div class="business-section">
						...
						<div class="col-md-12">
							...
							<h1 class="title">Create your E-Shop</h1>
							<hr>
						</div>
						<div class="col-md-12 no-padding">
							
							<!-- form -->
							{!! Form::open(array('route' => 'eshop.store','class'=>'form-horizontal', 'data-toggle'=>'validator','role'=>'form','method'=>'post','files'=>'true')) !!}
							<div class="form-group{{ $errors->has('subdomain') ? ' has-error' : '' }}">
								<label class="col-sm-3 control-label">SubDomain</label>
								<div class="col-sm-9">
								    <div class="input-group">
								    <input type="text" name="subdomain" class="form-control" placeholder="Your Subdomain" required pattern="[^', _/%+=)(^!@#$&{}\x22]+" value="{{old('subdomain')}}" title="Do no use special character. ">
							...
							<div class="form-group{{ $errors->has('eshop_name') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									<input name="eshop_name" type="text" class="form-control" placeholder="Ex: Smart Software" value="{{old('eshop_name')}}" required>
									<div class="help-block with-errors"></div>
							...
							<div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									<input name="title" type="text" class="form-control" placeholder="Ex: Best Software Solution" value="{{old('title')}}" required>
									<div class="help-block with-errors"></div>
									 @if ($errors->has('title'))
		                                <span class="help-block">
							...
							<div class="form-group{{ $errors->has('location') ? ' has-error' : '' }}">
								...
								<div class="col-sm-9">
									...
									<input name="location" type="text" class="form-control" placeholder="Address" value="{{old('location')}}" required>
									<div class="help-block with-errors"></div>
