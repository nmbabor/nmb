							...
							<div class="panel-default panel-faq">
								...
								<div class="panel-heading">
									<a data-toggle="collapse" data-parent="#accordion" href="#accordion-one">
										<h4 class="panel-title">{{$category->name}}<span class="pull-right"><i class="fa fa-minus"></i></span></h4>
									</a>
								</div><!-- panel-heading -->
								...
								<div id="accordion-one" class="panel-collapse collapse in">
									...
									<div class="panel-body">
										...
										<li>
										<a href='{{URL::to("/ads$divisionLink$areaLink")}}'>
										<b><i class="fa fa-angle-double-left"></i> Back to all categories </b></a></li>
											@foreach($subCategory as $cat)
												<li><a href='{{URL::to("ads/$divLink/$category->link/$cat->id$areaLink")}}'>
												<i class="fa fa-angle-right"></i> {{$cat->sub_category_name}}<span>({{$cat->ad}})</span></a></li>
											@endforeach
							...
							<div class="panel-default panel-faq">
								...
								<div id="accordion-location" class="panel-collapse collapse collapse in">
									...
									<div class="panel-body">
										...
										<li><a href='{{URL::to("/ads/bangladesh/$link")}}'><b><i class="fa fa-angle-double-left"></i>{{$division->name}} </b></a></li>
											@foreach($area as $div)
												<li class="sub-category @if(isset($filter['area']))  {{($filter['area']==$div->id) ?'active':''}} @endif"><a href='{{URL::to("ads/$divLink/$link?area=$div->id")}}'>
										...
										@else
											@foreach($division as $div)
												<li ><a href='{{URL::to("ads/$div->link/$link")}}'>
